...
<div class="container">
            ...
            <form>
                <div class="controls controls-row">
                    <input id="name" name="name" type="text" placeholder="Name" style="width: 500px;"> <br><br>
                    <input id="email" name="email" type="email"  placeholder="Email address" style="width: 500px;"><br><br>
                </div>
                <div class="controls">
